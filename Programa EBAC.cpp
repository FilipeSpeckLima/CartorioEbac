#include <stdio.h> //biblioteca de conunicaçâo com o usuario
...
int consulta()
{
	...
	{
		printf("\nEssas sâo as informações do usuário: ");
		printf("%s", conteudo);
		printf("\n\n");
	}
...
int deletar()
{
	...
	if(file == NULL)
	{
		printf("O usuário nâo se encontra no sistema. \n");
		system("pause");
	}
...
int main()
{
	...
	{	
		...
		printf("\t1 - Registrar nomes\n"); // \t da o espaço da esquerda para direita
		printf("\t2 - Consultar nomes\n");
		printf("\t3 - Deletar nomes\n"); 
		printf("\t4 - Sair do sistema\n");
		printf("Opção:"); // fim do meni
